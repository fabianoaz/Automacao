...

{
    ...
    class ConferenciaTurno
    {
        ...
        public void AcessarMenu(IWebDriver driver)
        {
            ...
            new WebDriverWait(driver, TimeSpan.FromSeconds(20)).Until(ExpectedConditions.ElementToBeClickable(By.XPath("//ul[@id='tab-diaDia']//li[2]//a")));

            driver.FindElement(By.XPath("//ul[@id='tab-diaDia']//li[2]//a")).Click();
